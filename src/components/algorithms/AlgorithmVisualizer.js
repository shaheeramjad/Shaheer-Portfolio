...
const AlgorithmVisualizer = () => {
  ...
  const initializeGrid = useCallback(() => {
    ...
    setGrid(newGrid);
  }, [START_NODE.row, START_NODE.col, END_NODE.row, END_NODE.col]);

  useEffect(() => {
    generateArray();
    initializeGrid();
  }, [generateArray, initializeGrid]);
    ...
    >
      ...
      >
        <p className="text-gray-400 text-lg leading-relaxed">
          This interactive algorithm visualizer demonstrates various sorting and
          pathfinding algorithms using{" "}
          <span className="text-designColor">React</span>,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            >
              ...
              <option value="pathfinding">Pathfinding Algorithms</option>
            </select>
          </div>
